...
// Modified by Benwei Shi for Project 2 of CS 3505.
...
namespace SS
{
    ...
    public partial class SpreadsheetPanel : UserControl
    {
        ...
        /// <summary>
        /// Clear error mark for a cell
        /// </summary>
        public void RemoveError(int col, int row)
        {
            drawingPanel.ClearError(col, row);
        }
        ...
        /// <param name="col"></param>
        /// <param name="row"></param>
        public void SetError(int col, int row)
        {
            drawingPanel.SetError(col, row);
        }
        ...
        /// <param name="col"></param>
        /// <param name="row"></param>
        public void SetEditing(int col, int row)
        {
            drawingPanel.SetEditing(col, row);
        }
        ...
        /// <param name="col"></param>
        /// <param name="row"></param>
        public void RemoveEditing(int col, int row)
        {
            drawingPanel.RemoveEditing(col, row);
        }
        ...
        private class DrawingPanel : Panel
        {
            ...
            // The error cell in the spreadsheet
            private HashSet<Address> _errors;
            // The cell editing by other collabrator.
            private List<Address> _editing;
            ...
            public DrawingPanel(SpreadsheetPanel ss)
            {
                ...
                _errors = new HashSet<Address>();
                _editing = new List<Address>();
                _ssp = ss;
            }
            ...
            /// </summary>
            public void ClearError(int col, int row)
            {
                if (InvalidAddress(col, row))
                {
                    return;
                }
                _errors.Remove(new Address(col, row));
                Invalidate();
            }
            ...
            public void SetError(int col, int row)
            {
                ...
                _errors.Add(new Address(col, row));
                Invalidate();
            }
            ...
            public void SetEditing(int col, int row)
            {
                ...
                _editing.Add(new Address(col, row));
                Invalidate();
            }
            ...
            public void RemoveEditing(int col, int row)
            {
                ...
                _editing.Remove(new Address(col, row));
                Invalidate();
            }
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                // Color the Error
                Brush brush = new SolidBrush(Color.LightPink);
                foreach (Address address in _errors)
                {
                    int x = address.Col - _firstColumn;
                    int y = address.Row - _firstRow;
                    e.Graphics.FillRectangle(brush,
                        LABEL_COL_WIDTH + x * DATA_COL_WIDTH,
                ...
                foreach (Address address in _editing)
                {
                    int x = address.Col - _firstColumn;
                    int y = address.Row - _firstRow;
                    e.Graphics.FillRectangle(brush,
            ...
            protected override void OnMouseClick(MouseEventArgs e)
            {
                ...
                {
                    SetSelection(x + _firstColumn, y + _firstRow);
                }
                Invalidate();
            }
